...
public class SurveyJpaRepositoryFactoryBean<R extends JpaRepository<T, ID>, T, ID extends Serializable> extends JpaRepositoryFactoryBean<R, T, ID> {
    ...
    private final static class SurveyJpaRepositoryFactory<T, ID extends Serializable> extends JpaRepositoryFactory {
        ...
        protected Object getTargetRepository(final RepositoryMetadata metadata) {
            ...
            return new SurveyJpaRepositoryImpl<T, ID>(domainClass, entityManager);
        }

        @Override
        protected Class<?> getRepositoryBaseClass(final RepositoryMetadata metadata) {
            return SurveyJpaRepository.class;
        }
    }
}
