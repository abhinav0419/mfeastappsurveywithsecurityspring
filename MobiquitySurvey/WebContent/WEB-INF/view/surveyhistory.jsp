  ...
  <h1>Survey History </h1>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">Survey Details</h3>
        ...
        <div class="table-responsive">
           <table class="table table-hover">
  				<tr>
  					...
  					<td><b>Veg Option</b></td>
  					<td><b>Jain Option</b></td>
  				...
  				<c:forEach var="list" items="${allFeastSurveyList}">
  				<tr>
  					<td>${list.surveyId}</td>
  					<td>${list.surveyName}</td>
  					<%-- <td>${list.surveyType}</td> --%>
  					<td>${list.vegOption}</td>
  					<td>${list.jainOption}</td>
				...
				<td>
				 ...
				 <a  id="${list.surveyId}" class="btn btn-primary deleteButton">Delete</a>
    ...
    $(".editButton").click(function() {
		...
		var id = $(this).attr('id');
		$("#mainContent").load("editsurvey/?surveyId="+id);
	});
    
$(".reportButton").click(function() {
		
		var id = $(this).attr('id');
		$("#mainContent").load("surveyreport/?surveyId="+id);
	});
$(".deleteButton").click(function() {
	
	var id = $(this).attr('id');
	$("#mainContent").load("deleteSurvey/?surveyId="+id);
});
    </script>
</body>
</html>