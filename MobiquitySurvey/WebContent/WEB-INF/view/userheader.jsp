				...
				<ul class="nav navbar-top-links navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu dropdown-user">
							<li><a href="#" id="uploadPicButton"> <i class="fa fa-user fa-fw"></i> Upload Profile Image </a></li>
				...
				<div class="navbar-default sidebar" role="navigation">
					<div class="row">
						<div class="col-md-12">
							<a data-toggle="modal" data-target="#myModal" class="thumbnail">
								<img class="image-rounded  img-responsive" src="showimg/${userId}" onerror="mob.png" alt="...">
							</a>
						</div>
					</div>
					<div class="sidebar-nav navbar-collapse">
						<ul class="nav" id="side-menu">
							...
							<li><a href="#" id="userProfile"><i class="glyphicon glyphicon-user"></i> Profile</a></li>
							<li><a href="#" id="ChangePassword" ><i class="glyphicon glyphicon-link"></i> Change Password</a></li>
						</ul>
					</div>
					<!-- /.sidebar-collapse -->
				</div>
